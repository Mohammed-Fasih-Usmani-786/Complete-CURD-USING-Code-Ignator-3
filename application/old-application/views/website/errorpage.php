        ...
        <div class="bnr-inr overlay-black-middle" style="background-image:url(assets/images/banner/bnr1.jpg);">
            <div class="container">
                <div class="bnr-inr-entry">
                    <h1 class="text-white">Enquire Now</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8">
                        <div class="p-a30 bg-gray clearfix m-b30 ">
							...
							<div class="dzFormMsg"></div>
								...
								<!-- <iframe src="contactform/contact_form.html" scrolling="no" style="display: block;  border: none; height: 450px; width: -webkit-fill-available;"></iframe> -->
						
						
						
							<form method="post" class="dzForm" action="mail.php">
							<input type="hidden" value="Contact" name="dzToDo" >
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <textarea name="dzMessage" rows="4" class="form-control" required placeholder="Type Your Message Here..."></textarea>
                                            </div>
                                        </div>
                                    </div>
									<div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <button name="submit" type="submit" value="Submit" class="site-button "> <span>Submit Now</span> </button>
                                    </div>
                                </div>
                            </form>
                        </div>
