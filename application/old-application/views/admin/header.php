    ...
    <ul class="mdl-menu mdl-list mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-shadow--2dp account-dropdown"
        ...
        <li class="mdl-list__item mdl-list__item--two-line">
            <span class="mdl-list__item-primary-content">
                ...
                <span><?=$_SESSION['_admin']['name'];?></span>
                <span class="mdl-list__item-sub-title"><?=$_SESSION['_admin']['mobile'];?></span>
            </span>
        </li>
    ...
    <div class="scroller" id="scroller">
        <div class="scroll__container" id="scroll__container">
            <nav class="mdl-navigation">
                <a class="mdl-navigation__link mdl-navigation__link--current" href="Admin">
                    <i class="material-icons" role="presentation">dashboard</i>
                    Dashboard
                </a>

                <a class="mdl-navigation__link" href="Admin/Customer">
                    <i class="material-icons" role="presentation">group</i>
                   All Enquery
                </a>

                <a class="mdl-navigation__link" href="Admin/Services">
                    <i class="material-icons" role="presentation">Services</i>
                   Servies
                </a>
              
                <a class="mdl-navigation__link" href="Admin/Blogs">
                    <i class="material-icons" role="presentation">receipt</i>
                    Blogs
                </a>

                <a class="mdl-navigation__link" href="Admin/Slider">
                    <i class="material-icons" role="presentation">receipt</i>
                    SLider
                </a>

                <a class="mdl-navigation__link" href="Admin/Brand-icon">
                    <i class="material-icons" role="presentation">receipt</i>
                    Brand Icon
                </a>

                <a class="mdl-navigation__link" href="Admin/Cities">
                    <i class="material-icons" role="presentation">receipt</i>
                    Cities
                </a>
                <a class="mdl-navigation__link" href="Admin/Gallery">
                    <i class="material-icons" role="presentation">receipt</i>
                    Gallery
                </a>
                ...
                <a class="mdl-navigation__link" href="Admin/Log-out">
