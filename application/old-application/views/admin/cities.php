...
<body>
                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title"  style="display: flex;    flex-direction: row;    justify-content: space-between;">
                            ...
                            <a href="Admin/Add-cities" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Add</a>
 ...
 display: inline-block;max-width:200px;"><?=$v['_subtitle'];?></td>
                                        ...
                                        <td>
                                        <a href="Admin/Update-cities/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">View</a>
                                        <a href="Admin/Cities?del=<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
