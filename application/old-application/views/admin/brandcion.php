                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title"  style="display: flex;    flex-direction: row;    justify-content: space-between;">
                            <h1 class="mdl-card__title-text">All Brand Icon </h1>

                            <a href="Admin/Add-brandcion" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Add</a>
                            ...
                            <table class="mdl-data-table mdl-js-data-table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><img src="brands/<?=$v['_img'];?>" alt="" width="60" srcset=""></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['_title'];?></td>                                      
                                        <td>
                                            <a href="Admin/Update-brandcion/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal">Edit</a>
                                            <a href="Admin/Brand-icon?del=<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
