                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <a href="Partner/Add-utr-fund?uid=<?=$v['rd'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal">Update</a>
                                      <a href="Partner/Add-utr-fund?cid=<?=$v['rd'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Cancel</a>
                                     <?php } ?>
                                        </td>
