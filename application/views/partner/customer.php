                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['date'];?></td>
                                         ...
                                         <td>
                                        <a href="Partner/View-enquery/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green">View</a>
                                        </td>
                                         <td>
                                        <a href="Partner/Customer?del=<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
