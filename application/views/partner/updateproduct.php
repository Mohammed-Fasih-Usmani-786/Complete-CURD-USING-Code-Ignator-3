                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            ...
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label"
                                    ...
                                    <img src="_mypro/<?= $user[0]['_banner']; ?>" width='100' alt="" value="<?= $user[0]['_banner']; ?>">
                            ...
                            <div class="row">
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label"
                                        ...
                                        <img src="_mypro/<?= $user[0]['img1']; ?>" width='100' alt="">
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label"
                                        ...
                                        <img src="_mypro/<?= $user[0]['img2']; ?>" width='100' alt="">
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--6-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label"
                                        ...
                                        <img src="_mypro/<?= $user[0]['img3']; ?>" width='100' alt="">
                                ...
                                ?>
                                    <tr>    
                                        <td>
                                            <a href="Partner/Delete?del=<?=$v['_img'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
                            ...
                            <!-- <?php foreach ($user as $row) { ?> -->
                                ...
                                <!-- <tr> -->
                                    ...
                                    <!-- <td>
                                            <a href='<?php echo site_url("Partner/Delete/" . $row->id); ?>'>
                            ...
                            <!-- <?php } ?> -->
                                        ...
                                        <!-- <a href="Partner/Delete?Del=<?=$v['row_id'];?>">
                                                Delete
                                        </a> -->
                                        <!-- <a href="Partner/Delete">
                                            Delete
                                        </a>    -->
                                        ...
                                        <!-- <a href='<?php echo site_url("Partner/del/" . $iarr->$iarr[2]); ?>' id="yes">
                                            Delete
                                        </a> -->
