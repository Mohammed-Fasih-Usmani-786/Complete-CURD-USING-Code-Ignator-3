                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <h1 class="mdl-card__title-text">View User Enquery : <?=$user['name']?>  </h1>
                        </div>
                        <div class="mdl-card__supporting-text no-padding">
                      
                             <div class="mdl-cell mdl-cell--12-col " style="width: 100%;   max-width: 400px;    display: flex;    flex-direction: row;    justify-content: space-between;">
                                        <strong>Date</strong>
                                        <strong><?=date("d-m-Y",strtotime($user['date']));?></strong>
