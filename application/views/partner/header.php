...
<header class="mdl-layout__header">
    <div class="mdl-layout__header-row" style="color:black;">
        ...
        <ul class="mdl-menu mdl-list mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-shadow--2dp account-dropdown" for="icon">
            ...
            <li class="list__item--border-top"><span class="mdl-list__item-primary-content">
                    <div class="avatar-dropdown" id="icon">
                        <span><?= $_SESSION['_admin']['Row_Id']; ?></span>
                    </div>
                </span></li>
            <li class="list__item--border-top"></li>

            <a href="Partner/Log-out">
        ...
        <div class="scroller" id="scroller">
            <div class="scroll__container" id="scroll__container">
                <nav class="mdl-navigation">
                    <a class="mdl-navigation__link mdl-navigation__link--current" href="Partner">
                    ...
                    <a class="mdl-navigation__link" href="Partner/Customer">
                        <i class="material-icons" role="presentation">
                            group
                        </i>
                        All Enquery
                    ...
                    <a class="mdl-navigation__link" href="Partner/Category">
                        <i class="material-icons" role="presentation">
                            receipt
                        </i>
                        Category
                    </a>
                    <a class="mdl-navigation__link" href="Partner/Add-category">
                        <i class="material-icons" role="presentation">
                    ...
                    <a class="mdl-navigation__link" href="Partner/Product">
                        <i class="material-icons" role="presentation">
                            Products
                        </i>
                        Products
                    ...
                    <a class="mdl-navigation__link" href="Partner/Add-product">
                        <i class="material-icons" role="presentation">

                        </i>
                        Add Products
                    </a>
                    <a class="mdl-navigation__link" href="Partner/Blogs">
                        <i class="material-icons" role="presentation">
                            receipt
                        </i>
                        Blogs
                    ...
                    <a class="mdl-navigation__link" href="Partner/Slider">
                        <i class="material-icons" role="presentation">
                            receipt
                        </i>
                        SLider
                    ...
                    <a class="mdl-navigation__link" href="Partner/Brand-icon">
                        <i class="material-icons" role="presentation">
                            receipt
                        </i>
                        Brand Icon
                    ...
                    <a class="mdl-navigation__link" href="Partner/Cities">
                        <i class="material-icons" role="presentation">
                            receipt
                        </i>
                        Cities
                    </a>
                    <a class="mdl-navigation__link" href="Partner/Gallery">
                        <i class="material-icons" role="presentation">
                            receipt
                        </i>
                        Gallery
                    ...
                    <a class="mdl-navigation__link" href="Partner/Log-out">
                        <i class="material-icons" role="presentation">
                            lock
                        </i>
                        Log out
