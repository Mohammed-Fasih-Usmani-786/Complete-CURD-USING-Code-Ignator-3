                ...
                <div class="mdl-cell mdl-cell--9-col-desktop mdl-cell--9-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title"  style="display: flex;    flex-direction: row;    justify-content: space-between;">
                            ...
                            <a href="Partner/Add-product" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Add</a>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            ...
                            foreach($user as $v){ 
                                ...
                                if ($v['client_id']== $_SESSION['_admin']['Row_Id']) {  ?>
                                    ...
                                    <!--<td class="mdl-data-table__cell--non-numeric"><?=$v['wet_type'];?></td>
                                        ...
                                        <td>
                                        <a href="Partner/Update-product/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">View</a>
                                        <a href="Partner/Product?del=<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
                                    <?php } } ?>
