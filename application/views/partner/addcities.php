                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <h1 class="mdl-card__title-text">Add Cities </h1>
                        ...
                        <?php if(!empty($user)){  ?>
                                ...
                                <div class="mdl-grid">                                    
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        ...
                                        <label class="mdl-textfield__label" for="firstName">City Name</label>
                                    </div>
                                </div>
                                <div class="mdl-grid">                                    
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                            ...
                            <?php }else{ ?>
                                ...
                                <div class="mdl-grid">                                    
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <input class="mdl-textfield__input" type="text" id="firstNamex" name="_subtitle" />
                                        <label class="mdl-textfield__label" for="firstNamex">Title</label>
                                    </div>
                                </div>
                                ...
                                <div class="mdl-grid">                                    
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <textarea class="mdl-textfield__input" type="text" id="firstNamez" name="_desr" ></textarea>
                                        <label class="mdl-textfield__label" for="firstNamez">Desctionpion</label>
                                    </div>
                                </div>
