                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <h1 class="mdl-card__title-text">Add Category </h1>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            ...
                            <?php if (!empty($user)) {  ?>
                                ...
                                <div class="mdl-grid">                                    
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <input class="mdl-textfield__input" type="text" id="firstName" name="name" value="<?=$user[0]['name'];?>" />
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <img src="./_services/<?=$user[0]['img'];?>" alt="" width="300" srcset="">
                                ...
                                <div class="mdl-grid">                                    
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <input class="mdl-textfield__input" type="text" id="firstName" name="des" value="<?=$user[0]['des'];?>" />
                                        <label class="mdl-textfield__label" for="firstName">Title</label>
                                    </div>
                                </div>
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <img src="_services/<?=$user[0]['img'];?>" alt="" width="300" height="300" srcset="">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <input class="mdl-textfield__input" type="file" id="firstName" name="img" />
                                        <label class="mdl-textfield__label" for="firstName"> Image</label>
                                    </div>
                                </div>

                                <div class="mdl-grid">
                                    <div class="mdl-cell mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%;">
                                        <input class="mdl-textfield__input" type="text" id="firstName" name="des" />
                                        <label class="mdl-textfield__label" for="firstName"> Des</label>
                                    </div>
                                </div>
                                <div class="form__action" style="margin:10px">
