...
<body>
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header is-small-screen">
        ...
        <main class="mdl-layout__content ">
                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <h1 class="mdl-card__title-text">All Token </h1>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            <table class="mdl-data-table mdl-js-data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="mdl-data-table__cell--non-numeric">Send Date</th>
                                        <th class="mdl-data-table__cell--non-numeric">Rec. name</th>
                                        <th class="mdl-data-table__cell--non-numeric">Rec. Mobile</th>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['b_date'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['s_date'];?></td>
            ...
            <form method="post" name="f_<?=$v['rd'];?>">
                <input type="hidden" name="rid" value="<?=$v['rd'];?>">
