...
<head>
    ...
    <title>Add Services Category</title>
                ...
                <div class="mdl-cell mdl-cell--9-col-desktop mdl-cell--9-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title" style="display: flex;    flex-direction: row;    justify-content: space-between;">
                            <h1 class="mdl-card__title-text">All Products Category </h1>

                            <a href="Adminpanal/Add-category" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Add</a>
                            ...
                            <table class="mdl-data-table mdl-js-data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="mdl-data-table__cell--non-numeric">Type Category</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="mdl-data-table__cell--non-numeric" style="overflow: hidden;text-overflow: ellipsis;white-space:nowrap;width: 100%;display: inline-block;max-width:200px;height:100px">
                                                <img src="_services/<?= $v['img'] ?>" alt="" height="50px" width="100px">
                                            </td>

                                            <td class="mdl-data-table__cell--non-numeric"><?= $v['des']; ?></td>
                                            <td>
                                                <a href="Adminpanal/Update-category/<?= $v['row_id']; ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">View</a>
                                                <a href="Adminpanal/Category?del=<?= $v['row_id']; ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                            </td>
                                        </tr>
