                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title"  style="display: flex;    flex-direction: row;    justify-content: space-between;">
                            <h1 class="mdl-card__title-text">All Order </h1>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['_city'];?></td>                                      
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['amount'];?></td>                                      
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['_gst'];?></td>                                      
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['o_date'];?></td>                                      
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['_status'];?></td>                                      
                                       
                                        <td>
                                        <a href="Adminpanal/View-customer-order/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">View</a>
