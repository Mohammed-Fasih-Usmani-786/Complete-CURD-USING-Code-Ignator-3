                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title"  style="display: flex;    flex-direction: row;    justify-content: space-between;">
                            <h1 class="mdl-card__title-text">All Cities </h1>

                            <a href="Adminpanal/Add-cities" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Add</a>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"  style="overflow: hidden;
 text-overflow: ellipsis;
 white-space: nowrap;
 width: 100%;
 display: inline-block;max-width:200px;"><?=$v['_subtitle'];?></td>
                                       
                                        <td>
                                        <a href="Adminpanal/Update-cities/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">View</a>
                                        <a href="Adminpanal/Cities?del=<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
