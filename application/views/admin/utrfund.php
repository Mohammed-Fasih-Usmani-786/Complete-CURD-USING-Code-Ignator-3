                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <h1 class="mdl-card__title-text">All utr </h1>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            <table class="mdl-data-table mdl-js-data-table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="mdl-data-table__cell--non-numeric">UTR NO</th>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['mobile'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['amount'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['utrno'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['cr_on'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=@$v['rna'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=@$v['rmo'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['status'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric">
                                            <?php if($v['status']=="Pending"){ ?>
                                      <a href="Adminpanal/Add-utr-fund?uid=<?=$v['rd'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal">Update</a>
                                      <a href="Adminpanal/Add-utr-fund?cid=<?=$v['rd'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Cancel</a>
                                     <?php } ?>
                                        </td>
