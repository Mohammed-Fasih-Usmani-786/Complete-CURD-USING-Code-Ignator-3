                ...
                <div class="mdl-cell mdl-cell--9-col-desktop mdl-cell--9-col-tablet mdl-cell--4-col-phone">
                    <div class="mdl-card mdl-shadow--2dp">
                        <div class="mdl-card__title" style="display: flex;    justify-content: space-between;">
                            <h1 class="mdl-card__title-text">All Enquery </h1>
                        ...
                        <div class="mdl-card__supporting-text no-padding">
                            <table class="mdl-data-table mdl-js-data-table" id="export">
                                <thead>
                                    <tr>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['email'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['city'];?></td>
                                        <td class="mdl-data-table__cell--non-numeric"><?=$v['date'];?></td>
                                       
                                         <td>
                                        <a href="Adminpanal/View-enquery/<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green">View</a>
                                        </td>
                                         <td>
                                        <a href="Adminpanal/Customer?del=<?=$v['row_id'];?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</a>
                                        </td>
                                    </tr>
