...
class PartnerDash extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('partner/index', $res);
    }
    ...
    public function customer()
    {
        ...
        $this->load->view('partner/customer', $res);
    }
    public function viewenquiery($id)
    {
        ...
        if (!empty($r)) {
            ...
            $this->load->view('partner/viewenquiery', $res);
        } else {
            redirect(site_url("PartnerDash"));
        }
    }
    ...
    public function uploadimage()
    {
        ...
        if (isset($_POST['save'])) {
            ...
            $this->load->view('partner/uploadimage', $res);
        }
    }
    ...
    public function services()
    {
        ...
        if (isset($_GET['del'])) {
            ...
            if (!empty($d)) {
                ...
                redirect(site_url("PartnerDash/Blogs"));
            }
        }
        ...
        $this->load->view('partner/services', $res);
    }
    ...
    public function addservices()
    {
        ...
        $this->load->view('partner/addservices', $res);
    }
    public function updateservices($id)
    {
        ...
        $this->load->view('partner/updateservices', $res);
    }
    ...
    public function blogs()
    {
        ...
        $this->load->view('partner/blogs', $res);
    }
    ...
    public function addblogs()
    {
        ...
        $this->load->view('partner/addblogs', $res);
    }
    ...
    public function slider()
    {
        ...
        $this->load->view('partner/slider', $res);
    }
    ...
    public function addslider()
    {
        ...
        $this->load->view('partner/addslider', $res);
    }
    ...
    public function brandcion()
    {
        ...
        $this->load->view('partner/brandcion', $res);
    }
    ...
    public function addbrandcion()
    {
        ...
        $this->load->view('partner/addbrandcion', $res);
    }
    ...
    public function gallery()
    {
        ...
        $this->load->view('partner/gallery', $res);
    }
    ...
    public function addgallery()
    {
        ...
        $this->load->view('partner/addgallery', $res);
    }
    ...
    public function category()
    {
        ...
        $this->load->view('partner/category', $res);
    }
    ...
    public function cities()
    {
        ...
        $this->load->view('partner/cities', $res);
    }
    ...
    public function updatecategory($id)
    {
        ...
        $this->load->view('partner/addcategory', $res);
    }
    ...
    public function addcities()
    {
        ...
        $this->load->view('partner/addcities', $res);
    }
    ...
    public function customerorder()
    {
        ...
        $this->load->view('partner/customerorder', $res);
    }
    public function viewcustomerorder($id)
    {
        ...
        $this->load->view('partner/viewcustomerorder', $res);
    }
    ...
    public function product()
    {
        ...
        if (isset($_GET['del'])) {
            ...
            if (!empty($d)) {
                ...
                print_r(@$this->medoo->delete("products2", ["row_id" => $_GET['del']]));
                delete_files("./product/" . $d[0]['row_id']);
                $m = "Successfully Delete";
            } else {
                redirect(site_url("PartnerDash/Product"));
            }
        }
        ...
        $this->load->view('partner/product', $res);
    }
    ...
    public function addproduct()
    {
        ...
        $this->load->view('partner/addproduct', $res);
    }
    ...
    public function updateproduct($id)
    {
        ...
        $this->load->view('partner/updateproduct', $res);
    }
